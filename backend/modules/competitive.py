...
async def generate(input_md: str) -> dict:
    ...
    reasoning_prompt = (
        ...
        "1. Direct genre competitors (survival MMO, open-world survival crafting)\n"
        "2. IP/theme competitors (sci-fi, Dune-adjacent)\n"
        "3. Monetization model competitors ($50 + MTX/Battle Pass)\n"
        "4. Platform competitors (Steam PC MMOs)\n"
